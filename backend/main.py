...
from api.routes import campus, analysis, simulation, mock_analysis, chat, detection
...
app.include_router(detection.router, prefix="/api/detection", tags=["Person Detection"])
